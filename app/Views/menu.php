    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
         ...
         <div class="sidebar-brand-text mx-3">Gudang Pena Pen Store</div>
      </a>
     ...
     <!-- <li class="nav-item">
        ...
        <!-- <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/barang">Barang</a> 
            <a class="collapse-item" href="/home/barang_masuk">Barang Masuk</a> 
            <a class="collapse-item" href="/home/barang_keluar">Barang Keluar</a> 
          </div> 
        </div>
      </li> -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/l_brg">Laporan Barang Masuk</a>
            <a class="collapse-item" href="/home/k_brg">Laporan Barang Keluar</a>
          </div>
        </div>
      </li>
