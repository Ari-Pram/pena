    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="<?php echo  base_url('img/logo/q.jpg')?>">
        </div>
         <div class="sidebar-brand-text mx-3">  Pen Store</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="/home/user">User</a>
            ...
            <a class="collapse-item" href="/home/penguna">Penguna</a> 
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseForm" aria-expanded="true"
         ...
         <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/barang">Pendataan Barang</a> 
            <a class="collapse-item" href="/home/barang_masuk">Stok Barang </a> 
            <a class="collapse-item" href="/home/barang_keluar">Penjualan</a> 
          </div> 
        </div>
      </li> 
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/l_brg">Stok Barang </a>
            <a class="collapse-item" href="/home/k_brg">Penjualan</a>
          </div>
        </div>
      </li>
